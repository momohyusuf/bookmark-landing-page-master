...
export default function Navbar() {
  ...
  return (
    <>
      {/* mobile active nav-bar */}
      <nav
        onClick={() => setSideBarToggle(false)}
        className={sideBarToggle ? 'show-sidebar' : 'remove-sidebar'}
      >
          ...
          <svg width="148" height="25" xmlns="http://www.w3.org/2000/svg">
            <g fill="none" fillRule="evenodd">
              <path
                ...
                fill={sideBarToggle ? '#fff' : '#242A45'}
                fillRule="nonzero"
              />
              <g>
                <circle
                  fill={sideBarToggle ? '#fff' : '#5267DF'}
                  cx="12.5"
                  cy="12.5"
                  r="12.5"
                />
      ...
      {/* end of mobile active nav-bar */}

      {/* show mobile active nav-bar */}
      {!sideBarToggle && (
